...
# two variables which will cause the game to end if either is True.
...
def comp_Bust():
    ...
    # forced the computer to draw another card if the value of their cards is under 16.

    if result > 21:
        result = "Bust"

    # sets the value of the computer's result to bust if they go over 21.
...
# determines who has won using the win() function.
